...
SOPCINFO_FILE := C:/Users/emilio/UNI/Magistrale/Embedded/progetto/Math_Training/SopC/DE10_Lite_SOPC.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10000a0
SOPC_SYSID_FLAG += --sidp=0x10000a0
ELF_PATCH_FLAG  += --sidp 0x10000a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1525870912
SOPC_SYSID_FLAG += --timestamp=1525870912
ELF_PATCH_FLAG  += --timestamp 1525870912
